...
/**
 * The email is not listed here. It comes from Site settings, which is the only
 * place it is stored: a second copy in the code is how a site and a CV drift
                                    ...
                                    <div className="flex flex-col gap-[30px]">
                                        ...
                                        <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[620px] mx-auto xl:mx-0">
                                            ...
                                            <li className="flex items-center justify-center xl:justify-start gap-4">
                                                ...
                                                <a
                                                    href={`mailto:${resumeInfo.aboutMe.email}`}
                                                    className="text-xl hover:text-emerald-400 transition-colors"
                                                >
                                                    {resumeInfo.aboutMe.email}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
