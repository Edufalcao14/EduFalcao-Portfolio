...
const seedCase = async () => {
  ...
  const data = {
    ...
    slug: 'buvio',
    summary:
      'Buvio started as an idea between friends. After a match, during the third half our football team keeps with religious care, the post-game beer, someone said the Top and the Flop of the night deserved a proper vote. I turned that into a React Native app.\n\nI shipped it to TestFlight for my teammates first, and it grew to a little over 50 users. I stopped working on it after a few months: it asked for more time than I could give and I saw no path to it paying for itself. The code is open source on my GitHub.\n\nExpo on iOS and Android over a GraphQL API on Node and Postgres. The vote runs live over a WebSocket subscription, a session closes by admin, by deadline or by unanimity, and a verdict, once written, never changes.',
    body: null,
